...
@Repository
public class MilvusRentAdsRepository implements VectorAdsRepository {

    private final MilvusServiceClient milvusClient;
    private static final String COLLECTION_NAME = "RENTING_AD_COLLECTION";
    ...
    public MilvusRentAdsRepository(MilvusServiceClient serviceClient) {
    ...
    public static void main(String[] args) {
        ...
        MilvusRentAdsRepository repo = new MilvusRentAdsRepository(client);
        if (repo.hasCollection()) {
            repo.dropCollection();
        }
        repo.createCollection(5000);
        AdStub ad1 = AdStub.builder()
                .id(Long.valueOf(1))
                .town("Town1")
                .neighbourhood("Neighbourhood1")
                .accommodationType(AccommodationType.ONE_ROOM)
                .price(500)
                .build();

        AdStub ad2 = AdStub.builder()
                .id(Long.valueOf(2))
                .town("Town2")
                .neighbourhood("Neighbourhood2")
                .accommodationType(AccommodationType.TWO_ROOM)
                .price(750)
                .build();

        AdStub ad3 = AdStub.builder()
                .id(Long.valueOf(3))
                .town("Town3")
                .neighbourhood("Neighbourhood3")
                .accommodationType(AccommodationType.THREE_ROOM)
                .price(800)
                .build();
...
//                embedding.add(rand.nextFloat(1000));
//            }
//            embeddings.add(embedding);
//        }
//
//        repo.createPartition("Sofia");
//        repo.createIndex();
//        repo.insertProperties("Sofia", embeddings, List.of(ad1, ad2, ad3));
//        repo.loadCollection();
//        repo.query("ad_id < 3");
    }
